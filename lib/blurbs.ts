...
const BLURBS: Record<string, Copy> = {
  ...
  'ai-token-in': {
    ko:
      "AI가 내놓은 초안은 몇 초면 도착합니다. 그것을 제출해도 되는지, 공유해도 되는지 판단하는 일은 사람의 몫입니다. 『AI 토큰 경제학』 인도 스페셜 에디션 — 대학 과제와 인턴십, 그리고 첫 직장을 위한 책입니다. 일본을 배경으로 한 삽화 이야기 속 다카시와 쿄코를 따라간 뒤, 같은 생각을 인도의 대학과 사회 초년생의 상황에 옮겨 연습합니다. 무엇을 만족해야 완성인지 기준을 세우고 초안을 근거와 대조하기, 토큰과 사용 요금을 이해하되 싼 값을 쓸 만한 결과와 혼동하지 않기, 아무도 청구서에 적지 않는 확인 시간과 실패한 시도를 기록하기, 무엇을 맡기고 누가 검토하며 언제 멈출지 정하기. 실천 노트 아홉 권, 장별 과제 열여덟 개, 인도 연습문제 열여덟 개에 힌트와 예시 답이 붙어 있습니다. 경제학도 프로그래밍도, 유료 AI 계정도 필요 없습니다 — 종이 위에서 다 풀 수 있습니다.",
    ja:
      "AIの下書きは数秒で届く。それを提出してよいか、共有してよいかを決めるのは人の判断です。『AIトークン経済学』インド特別版 — 大学の課題、インターンシップ、そして最初の仕事のために。日本を舞台にした挿絵入りの物語でたかしときょうこを追ったあと、同じ考え方をインドの大学と新社会人の場面に移して練習します。何を満たせば完成かの基準を決めて下書きを根拠と照合する、トークンと従量料金を理解しつつ「安い」と「使える」を混同しない、誰も請求しない確認の時間と失敗した試行を記録する、何を任せ、誰が確かめ、どこでやめるかを決める。実践ノート九冊、章ごとの課題十八問、インド向け演習十八問に、ヒントと解答例つき。経済学もプログラミングも、有料のAIアカウントも不要 — 紙の上で解けます。",
    hi:
      "AI का मसौदा कुछ सेकंड में आ जाता है। वह जमा करने, साझा करने या इस्तेमाल करने लायक है या नहीं — यह तय करना इंसान का काम है। 'द AI टोकन इकॉनमी' का इंडिया स्पेशल एडिशन, कॉलेज प्रोजेक्ट, इंटर्नशिप और पहली नौकरी के लिए। जापान की सचित्र कहानी में ताकाशी और क्योको के साथ चलिए, फिर वही विचार भारतीय कॉलेज और शुरुआती नौकरी की परिस्थितियों पर लागू कीजिए: स्वीकृति की कसौटी तय करना और मसौदे को उसके स्रोतों से मिलाना; टोकन और उपयोग शुल्क समझना, बिना सस्ते दाम को उपयोगी नतीजा मान लिए; जाँच का वह समय और असफल कोशिशें दर्ज करना जिनका कोई बिल नहीं बनता; और तय करना कि क्या सौंपना है, जाँचेगा कौन, और रुकना कब है। नौ अभ्यास नोटबुक, अठारह अध्याय चुनौतियाँ और अठारह भारतीय अभ्यास, संकेत और हल सहित। न अर्थशास्त्र चाहिए, न प्रोग्रामिंग, न कोई पेड AI खाता — सब कागज़ पर हो जाता है।",
    fil:
      "Dumarating ang draft ng AI sa loob ng ilang segundo. Ang pag-alam kung handa na itong isumite, ibahagi o gamitin ay nangangailangan ng pagpapasya ng tao. Ito ang India Special Edition ng The AI Token Economy, para sa mga proyekto sa kolehiyo, internship at unang trabaho. Sundan sina Takashi at Kyoko sa isang may-larawang kuwento sa Japan, pagkatapos ay isabuhay ang parehong ideya sa mga sitwasyon sa kolehiyo at maagang trabaho sa India: pagtatakda ng pamantayan ng pagtanggap at pagsusuri ng draft laban sa mga pinagkunan nito; pag-unawa sa token at singil sa paggamit nang hindi ipinagkakamali ang mura sa kapaki-pakinabang; pagtatala ng oras ng pagsusuri at ng mga nabigong pagtatangka na walang naniningil; at pagpapasya kung ano ang ipauubaya, sino ang susuri, at kailan titigil. Siyam na practice notebook, labingwalong hamon sa bawat kabanata at labingwalong pagsasanay para sa India, may mga pahiwatig at sagot. Hindi kailangan ng ekonomiks, programming o bayad na AI account — kayang gawin sa papel.",
    de:
      "Ein KI-Entwurf ist in Sekunden da. Ob er eingereicht, geteilt oder verwendet werden kann, entscheidet ein Mensch. Die India Special Edition von The AI Token Economy — für Studienprojekte, Praktika und die erste Stelle. Begleiten Sie Takashi und Kyoko durch eine illustrierte Geschichte in Japan und übertragen Sie dieselben Gedanken dann auf indische Hochschul- und Berufseinstiegssituationen: Abnahmekriterien festlegen und einen Entwurf an seinen Quellen prüfen; Tokens und Nutzungsgebühren verstehen, ohne einen niedrigen Preis mit einem brauchbaren Ergebnis zu verwechseln; die Prüfzeit und die gescheiterten Versuche festhalten, die niemand in Rechnung stellt; und entscheiden, was man abgibt, wer es prüft und wann man aufhört. Neun Praxishefte, achtzehn Kapitelaufgaben und achtzehn Indien-Übungen, mit Hinweisen und Lösungen. Weder Wirtschaftswissenschaft noch Programmieren noch ein bezahltes KI-Konto nötig — die Übungen gehen auf Papier.",
    fr:
      "Un brouillon d'IA arrive en quelques secondes. Savoir s'il est prêt à être rendu, partagé ou utilisé demande du jugement. L'India Special Edition de The AI Token Economy, pour les projets d'études, les stages et le premier poste. Suivez Takashi et Kyoko dans une histoire illustrée située au Japon, puis reprenez les mêmes idées dans des situations d'université et de début de carrière en Inde : fixer des critères d'acceptation et confronter un brouillon à ses sources ; comprendre les tokens et la facturation à l'usage sans confondre un prix bas avec un résultat utilisable ; consigner le temps de vérification et les tentatives ratées que personne ne facture ; et décider quoi déléguer, qui vérifie et quand s'arrêter. Neuf carnets de pratique, dix-huit exercices de chapitre et dix-huit exercices indiens, avec indices et corrigés. Ni économie, ni programmation, ni compte IA payant — tout se fait sur papier.",
    es:
      "Un borrador de IA llega en segundos. Saber si está listo para entregar, compartir o usar exige criterio. Esta es la India Special Edition de The AI Token Economy, pensada para trabajos de carrera, prácticas y el primer empleo. Acompañe a Takashi y Kyoko en una historia ilustrada ambientada en Japón y traslade después las mismas ideas a situaciones de universidad y de primer trabajo en India: fijar criterios de aceptación y cotejar un borrador con sus fuentes; entender los tokens y los cargos por uso sin confundir un precio bajo con un resultado aprovechable; registrar el tiempo de revisión y los intentos fallidos que nadie factura; y decidir qué delegar, quién lo revisa y cuándo parar. Nueve cuadernos de práctica, dieciocho retos de capítulo y dieciocho ejercicios de India, con pistas y soluciones. No hace falta economía, ni programación, ni una cuenta de IA de pago — los ejercicios se resuelven en papel.",
    pt:
      "Um rascunho de IA chega em segundos. Saber se ele está pronto para entregar, compartilhar ou usar exige julgamento. Esta é a India Special Edition de The AI Token Economy, feita para trabalhos de faculdade, estágios e o primeiro emprego. Acompanhe Takashi e Kyoko em uma história ilustrada ambientada no Japão e depois leve as mesmas ideias para situações de faculdade e início de carreira na Índia: definir critérios de aceitação e conferir um rascunho com suas fontes; entender tokens e cobranças de uso sem confundir preço baixo com resultado aproveitável; registrar o tempo de conferência e as tentativas frustradas que ninguém fatura; e decidir o que delegar, quem confere e quando parar. Nove cadernos de prática, dezoito desafios de capítulo e dezoito exercícios da Índia, com dicas e respostas. Não é preciso economia, programação nem conta paga de IA — os exercícios funcionam no papel."
  },
  'ai-answer': {
    ko:
